...
solveTree ndsComp es = (comps `par` comp2size `par` node2comp `par` comp2id `par` id2comp `par` adjList) `pseq` ans
  where
    ...
    id2size = listArray (1, cnum) $ map (comp2size!!!) comps :: UArray Int Int
